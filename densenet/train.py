...
model_dir = 'model'
model_name = 'denception_v1_k{}{}'.format(model_growth_rate, model_config)
...
if len(saved_model) > 0:
    ...
    net = denception.DenseNet(num_init_features=model_init_features, growth_rate=model_growth_rate,
